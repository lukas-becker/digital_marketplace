...
<div class="container my-5 pt-5">
    ...
    <form enctype="multipart/form-data" class="px-5" method="post"
          action="/controller/article_controller.php?create_auction=true">
        <!-- Title -->
        <div class="row my-3">
        ...
        <!-- Stock -->
        <div class="row my-3">
            <label for="stock" class="form-label fs-4">Auction End time</label>
            <div class="col-12 col-4 p-0">
                <input class="form-control" type="datetime-local" id="auctionEnd" name="auctionEnd"
